  ...
  <div>
    ...
    <v-app-bar color="primary" dark dense fixed clipped-left app>
      ...
      <v-toolbar-title class="mr-5 align-center">
        <v-btn text plain link to="/" class="title">YouNotes</v-btn>
      </v-toolbar-title>
      <v-spacer />
      <!-- <v-btn text rounded to="/">Home</v-btn> -->
      <v-layout row align-center style="max-width: 300px">
        <v-text-field
          placeholder="Search..."
          single-line
      ...
      <!-- <v-spacer />
      <v-btn text rounded to="/editnote">Edit</v-btn> -->
    </v-app-bar>
  </div>

  <!-- <div class="nav">
    <nuxt-link to="/" class="brand">My Navbar Title</nuxt-link>
    <nav>
      <nuxt-link to="/">Home</nuxt-link>&nbsp;|
      <nuxt-link to="/editnote">Edit Note</nuxt-link>
    </nav>
  </div> -->
</template>
