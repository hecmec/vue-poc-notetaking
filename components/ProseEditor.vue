  ...
  methods: {
    setupProseMirror: function (content, editor) {
      ...
      this.view = new MenuBarEditorView(editor, {
        ...
        onAction: (action) => {
          self.$emit("content-change-editor", action);
          self.content.editor = this.view.editor.state.doc;
          self.content.markdown = defaultMarkdownSerializer.serialize(
            this.view.editor.state.doc
          );
        },
      });
    ...
    bindTextarea: function (area) {
      ...
      function mtodoc() {
        ...
        self.$emit("content-change-markdown");
      }
      // emulate v-model
...
.ProseMirror-widget *::selection {
  background: transparent;
}
.ProseMirror-nodeselection *::-moz-selection,
.ProseMirror-widget *::-moz-selection {
  background: transparent;
}
